...
// --------------------------------------------
{
    ...
    var anyFun = function () { return ['RatanLal', 'haveli', 789]; };
    anyFun();
    // returnType will be (string | number)[]
    // if data is coming from api
    var apiData = function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, ['neon', 'bright', 77]];
    }); }); };
    apiData();
}
